#pragma once
#ifndef LGFX_XIAO_ESP32S3_SPI_ST7789B_HPP
#define LGFX_XIAO_ESP32S3_SPI_ST7789B_HPP
#include <LovyanGFX.hpp>

// ESP32でLovyanGFXを独自設定で利用する場合の設定例

/// 独自の設定を行うクラスを、LGFX_Deviceから派生して作成します。
class LGFX_XIAO_ESP32S3_SPI_ST7789B : public lgfx::LGFX_Device
{
  /*
...
public:
  ...
  LGFX_XIAO_ESP32S3_SPI_ST7789B(void)
  {
    {                                    // バス制御の設定を行います。
      ...
      cfg.pin_mosi = 9;  // SPIのMOSIピン番号を設定
